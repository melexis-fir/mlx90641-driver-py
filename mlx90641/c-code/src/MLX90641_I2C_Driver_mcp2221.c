...
MLX90641_get_register_mcp2221(void)
{
  static struct MLX90641DriverRegister_t reg;

  strcpy(reg.name_, "mcp://mcp:2221/");
  reg.MLX90641_get_i2c_handle_  = MLX90641_get_i2c_handle_mcp2221;
  reg.MLX90641_set_i2c_handle_  = MLX90641_set_i2c_handle_mcp2221;
  reg.MLX90641_I2CInit_         = MLX90641_I2CInit_mcp2221;
  reg.MLX90641_I2CClose_        = MLX90641_I2CClose_mcp2221;
  reg.MLX90641_I2CRead_         = MLX90641_I2CRead_mcp2221;
  reg.MLX90641_I2CFreqSet_      = MLX90641_I2CFreqSet_mcp2221;
  reg.MLX90641_I2CGeneralReset_ = MLX90641_I2CGeneralReset_mcp2221;
  reg.MLX90641_I2CWrite_        = MLX90641_I2CWrite_mcp2221;
  return &reg;
}


void *
MLX90641_get_i2c_handle_mcp2221(void)
{
...
void
MLX90641_set_i2c_handle_mcp2221(void *handle)
{
...
void MLX90641_I2CInit_mcp2221(const char *port) 
{
  ...
  if (g_handle == NULL)
  {
    printf("MLX90641 MCP2221 ERROR: not able to open USB link\n");
    exit(1);
  }
